<?php /* Smarty version 2.6.13, created on 2010-11-08 22:51:05
         compiled from CUsuario_verSelecionarAcessos.html */ ?>
...
">
	<div class="container0 ui-widget-content ui-corner-all">
		...
		<div class="texto">
			<div class="tabela2">
				<div class='campo'>
					<label><?php echo $this->_tpl_vars['nomeNmLogin']; ?>
:</label>
					<span><?php echo $this->_tpl_vars['idUsuario'];  echo $this->_tpl_vars['nmLogin']; ?>
</span>
				</div>
			</div>
	        <div id='menu_corpo'>
	...
	<div class="container0">
		...
		<div class="texto">
			...
			<table summary="text" class="tabela1">
				<tr><th>Entidade</th><th colspan='2'>Acesso</th><!--<th colspan='2'>Dt.Início</th><th colspan='2'>Dt.Fim</th>--></tr>
