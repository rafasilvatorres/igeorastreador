<?php /* Smarty version 2.6.13, created on 2010-11-02 15:40:34
         compiled from CTipoLocal_verPesquisa.html */ ?>
<!---------------------- TEMPLATE PADRÃO ---------------------->
...
" >
	<div class="container0 ui-widget-content ui-corner-all">
		...
		<div class="texto">
			<div class="tabela2">
									<div class="campo">
						<label for="dsTipoLocal"><?php echo $this->_tpl_vars['nomeDsTipoLocal']; ?>
:</label>
						<span><?php echo $this->_tpl_vars['dsTipoLocal']; ?>
</span>
					</div>
							</div>
	        <div id='menu_corpo'>
